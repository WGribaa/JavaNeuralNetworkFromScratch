...
public abstract class Matrix {
     ...
     */
    public static double[][] matrixProduct(double[][] matrix1, double[][] matrix2) throws NonMatchingSizesException {
     ...
     */
    public static double[] matrixProduct(double[] array, double[][] matrix) throws NonMatchingSizesException {
    ...
    public static String toString(double[][] matrix){
        ...
        for (double[] doubles : matrix) {
            for (double aDouble : doubles) sb.append(aDouble).append("\t");
            sb.append("\n");
        }
        return sb.toString();
    }
